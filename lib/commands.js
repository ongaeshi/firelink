...
exports.importFromClipboard = function(panel) {
  fl.notifyClipboard(Localize.text.importFromClipboard);
...
exports.exportFromClipboard = function() {
  ...
  fl.notifyClipboard(Localize.text.exportFromClipboard);
}

exports.clearSetting = function(panel) {
  notify.n(Localize.text.clearSetting, Localize.text.removeAllLinkform);
  panel.postMessage({kind: "save"});
}

exports.restoreSetting = function(panel) {
  notify.n(Localize.text.restoreSetting, Localize.text.restoreInitLinkform);
  panel.postMessage({kind: "save"});
}
