...
function setupIN(rootMenu, context, contentScript, linkformData, currentIndex) {
  ...
  var directSelectSettingItem = setupDirectSelectSettingItem();
  ...
  if (copyItem != null) {
    ...
    // Setting
    items.push(directSelectSettingItem);
...
exports.setupAll = function() {
  ...
  menuContextPage = setupIN(menuContextPage,
                            ...
                            '  self.postMessage({data:data, text:document.title, title:document.title, url:document.location.href}); ' +
                            '});',
                            linkformData,
                            currentIndex
                           );
  ...
  menuContextSelection = setupIN(menuContextSelection,
                                 ...
                                 'self.on("click", function (node, data) { ' +
                                 '  self.postMessage({data:data, text:null, title:document.title, url:document.location.href}); ' +
                                 '});',
                                 linkformData,
                                 currentIndex
                                );
